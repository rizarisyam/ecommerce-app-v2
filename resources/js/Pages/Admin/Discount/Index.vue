...
<!-- This example requires Tailwind CSS v2.0+ -->
  ...
  <div class="pb-5 border-b border-gray-200 sm:flex sm:items-center sm:justify-between">
    ...
    <div class="mt-3 sm:mt-0 sm:ml-4">
        <a :href="route('product-discounts.create')">
    ...
    Not active
            ...
            <template v-slot:actions="data">
                <div class="w-32 flex justify-around text-xl">
                    <a :href="
                            route('product-discounts.edit', data.value.id)
                        ">
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const data = reactive(props.discounts)
        ...
        const deleteCategory = (id) => {
            Inertia.delete(route('product-discounts.destroy', id));
